  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-4 gap-4">
        ...
        <button  onClick={onSendClick} className="bg-slate-800 hover:bg-slate-700 text-slate-300 font-semibold py-4 px-6 rounded-xl transition">
          <div className="text-2xl mb-2">📥</div>
          <div className="text-sm">Receive</div>
        </button>
        <button className="bg-slate-800 hover:bg-slate-700 text-slate-300 font-semibold py-4 px-6 rounded-xl transition">
          <div className="text-2xl mb-2">⚡</div>
